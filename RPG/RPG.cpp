...
enum LOCATION {QUIT, TOWN, FOREST, VIEWSTATS, MONSTER, ARMORSMITH, BUYARMOR, SELLARMOR, WEAPONSMITH, BUYWEAPON, SELLWEAPON, ALCHEMIST, BUYPOTION};
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	Character *Player1;
	system("CLS");
	cout << "welcome to the lands of yarnik\n";
	while (reroll == true)
	{
